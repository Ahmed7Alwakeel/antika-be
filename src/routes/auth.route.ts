...
authRouter
	.route("/signup")
	.post(authController.signup, verificationController.sendVerifyEmail)
...
authRouter
	.route("/send/verify_email")
	.post(verificationController.sendVerifyEmail)
authRouter
	.route("/send/email/verify/:token")
	.get(verificationController.verifyEmail)
